...
<html lang="en">
    ...
    <head>
    <link rel="shortcut icon" href="assets/ico/8.jpg" type="image/x-icon">
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <title> Login Admin management</title>
        <a href="account.php"><i>Return to Website</i></a>
        ...
        <link rel="shortcut icon" href="assets/ico/8.png" type="image/x-icon">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Login </strong>Admin management</h1>
                        </div>
                    </div>
                    <div class="row">
