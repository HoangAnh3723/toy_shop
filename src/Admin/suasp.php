...
?>
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Admin management</a></li>
          </ol>
        </section>
        <!-- Main content -->
                ...
                <form class="form-horizontal"  method="POST" action="<?php include 'xulusuasp.php'?>" enctype="multipart/form-data">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                      <label for="inputPassword3" class="col-sm-2 control-label">Current image:   </label>
                        <div class="col-sm-10">
                    ...
                    ?>
                    <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label" >Sale</label>
                    <div class="col-sm-10">
                    <select class="form-control select2" style="width: 100%;" name="khuyenmai">
                    <option selected="selected" value="1">Have sale</option>
                    ...
                    <?php
                     ...
                     ?>
                                    <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label" >Sale price</label>
                    <div class="col-sm-10">
