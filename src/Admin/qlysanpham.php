            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Manage Toy</h3>
                </div><!-- /.box-header -->
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <i class="fa fa-edit fa-lg"<acronym title="Edit"></acronym></i>
                       </a>
                        <a class="btn btn-danger" onclick="return confirm('Do you actually want to delete ?');" href="xoasp.php?id=<?php  echo $row["ID"]  ?>" onclick="myFunction()">
                        <i class="fa fa-trash-o fa-lg" <acronym title="Delete">
                         </acronym></i></a></td>
                        </td>
                        <?php
                          }
