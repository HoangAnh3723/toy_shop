...
?>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> Home page</a></li>
                    ...
                    <?php
                      ...
                      ?>      
                        ...
                        <i class="fa fa-edit fa-lg"<acronym title="Chỉnh sửa"></acronym></i></a>               
                         <a class="btn btn-danger" onclick="return confirm('Do you actually want to delete it ?');" href="xoahasx.php?id=<?php  echo $row["ID"]  ?>">                   <i class="fa fa-trash-o fa-lg" <acronym title="Delete">
                         </acronym></i></a></td>
                      </tr>  
                      <?php
                          }
