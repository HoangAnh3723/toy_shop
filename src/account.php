...
if(isset($_POST['submit']))
{
    ...
    {
        $kq ="Wrong informations. Please cheack again.!!!";
    }
}
?>
<?php
...
if(isset($_POST['dangky']))
{
    ...
    else
    {
        ...
        if (mysqli_query($conn, $sql)) {
            ...
            $kqdk = "Register's not success. Please check again informations!!!";
        }
    }
...
?>
	<div id="page-content" class="single-page">
		<div class="container">
			...
			<div class="row">
			<div class="col-md-6">
					<div class="heading"><h2>Admin</h2>
				<a href="Admin/login.php"><i>Click here</i></a>
				</div>
				...
				<div class="col-md-6">
					...
					<form name="form1" id="ff1" method="POST" action="#">
						...
						<a href="#"></a>
						<br>
					<i>You dont't have a account? Please register here.</i>
					</form>
				</div>
				<div class="col-md-6">
					...
					<form name="form2" id="ff2" method="post" action="#">
						...
						<button type="submit" name="dangky" class="btn btn-1">Register</button>
