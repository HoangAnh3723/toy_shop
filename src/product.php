					...
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								...
								<input type="hidden" name="acction" value="add to cart" />
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="text-align: center">Customer infor</h4>
        </div>
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
					...
					<div class="product-desc">
						<ul class="nav nav-tabs">
							<li class="active"><a href="#description">Toy infor</a></li>
						</ul>
